 ...
 */
final class Version20201125143122 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE quack (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, autor_id INTEGER DEFAULT NULL, content VARCHAR(255) NOT NULL COLLATE BINARY, created_at DATETIME NOT NULL, picture VARCHAR(255) DEFAULT NULL COLLATE BINARY, comment CLOB DEFAULT NULL, CONSTRAINT FK_83D44F6F14D45BBE FOREIGN KEY (autor_id) REFERENCES duck (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
